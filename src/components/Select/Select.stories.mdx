  ...
  <Story
    ...
    play={async ({ args }) => {
      ...
      {() => {
        ...
        return <Select options={['Danish', 'English', 'French', 'German', 'Norwegian']} option={option} setOption={setOption} fixedOptions={['English', 'Norwegian']}/>
      }}
    </Story>
</Canvas>
...
<Canvas>
  <Story
    ...
    {() => {
      ...
      return <Select options={options} option={option} setOption={setOption} fixedOptions={['English', 'Norwegian']} loading={loading}/>
    }}
  </Story>
</Canvas>
