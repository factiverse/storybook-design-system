  ...
  <Story
    ...
    play={async ({ args }) => {
      ...
      {() => {
        ...
        return <SelectWithSearch label='Languages' options={['Danish', 'English', 'French', 'German', 'Norwegian']} option={option} setOption={setOption} fixedOptions={['English', 'Norwegian']}/>
      }}
    </Story>
</Canvas>
